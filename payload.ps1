...
function CheckFile { 
    ...
    if (-not (Test-Path $FilePath)) { 
        Check3rdAV
        Write-Host "Failed to create the file in temp folder, aborting!"
...
$FilePaths = @("$env:SystemRoot\Temp\NoCapture*.exe", "$env:USERPROFILE\AppData\Local\Temp\NoCapture*.exe")
